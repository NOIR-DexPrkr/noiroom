...
*Se copia la carpeta en "android/obb" y se instala el apk después.*

- [Sims Mobile mod](https://liteapks.com/download/the-sims-mobile-14600)    
*El mod se activa comprando un mueble cualquiera luego del tutorial.*

- [Sims Free to Play](https://liteapks.com/download/the-sims-freeplay-15127)    
*Solo entras y todo está gratis. Hay dos versiones del mod. Una con dinero ilimitado, y otra con eso más vip.*
...
::: details **Instrucciones de instalacion Sims 1**
...
**OJO:** *Cambia las 'Sombras' de alta a baja o media a través de las opciones gráficas del juego, de lo contrario, aparecerá un cuadro negro debajo de tus Sims en lugar de sombras interiores.*   
...
::: details **Instrucciones de instalacion Sims 3**
...
::: details **Instrucciones de instalacion Sims 4**
...
![](https://i.postimg.cc/8Cp4rtDx/aoe.webp)

::: details **Como descargar los juegos**
...
> Si tienes problemas con la instalacion reportalos en [Discord](https://discord.gg/hVKeY3uEru) 
...
## Coleccion Call of Duty

![cod](https://imgs.callofduty.com/content/dam/atvi/callofduty/cod-touchui/blog/common/cod-jobs-banner.jpg)
